#!/usr/bin/env python3
"""Add the compact responsive filter drawer and subtle card size styling."""
from pathlib import Path

BASE = Path(__file__).resolve().parents[1]
PATH = BASE / "assets" / "catalog-filter-simplify.js"
MARKER = "d119CompactFilterDrawer"
...
def main() -> None:
    ...
    if MARKER in text:
        print("Kompakter Filter-Drawer bereits vorhanden.")
        return
    PATH.write_text(text.rstrip() + ADDON + "\n", encoding="utf-8")
    print("Kompakten Desktop/Mobile-Filter-Drawer ergänzt.")
