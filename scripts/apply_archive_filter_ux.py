...
def patch_app(text: str) -> str:
    ...
    # Normalized size values are canonical English internally, but should still
    # be displayed in the selected interface language.
    text = replace_once(
        text,
        ...
        "Normalisierte Größenübersetzung",
    )
